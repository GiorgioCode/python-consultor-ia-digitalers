# Guias de estudio de Python desde cero
...
2. [Primer programa, comentarios y errores comunes](02_primer_programa.md)
3. [Variables y tipos de datos basicos](03_variables_y_tipos_de_datos.md)
4. [Entrada y salida de datos](04_entrada_y_salida.md)
5. [Operadores y expresiones](05_operadores_y_expresiones.md)
6. [Condicionales](06_condicionales.md)
7. [Bucles](07_bucles.md)
8. [Listas, tuplas y diccionarios](08_colecciones.md)
...
- Lee una guia por vez.
- Copia los ejemplos en un archivo `.py` y ejecutalos.
- Cambia valores para ver que pasa.
